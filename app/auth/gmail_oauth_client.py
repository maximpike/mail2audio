...
class GmailOAuthClient:
    ...
    def __init__(self, credentials_file: str, token_file: str, scopes: list, redirect_uri: str) -> None:
    ...
    def get_authorisation_url(self) -> tuple[Any, Any]:
        try:
            flow = Flow.from_client_secrets_file(
                client_secrets_file=self.credentials_file,
                scopes=self.scopes
            )
    ...
    def exchange_code_for_token(self, code: str, state: str) -> dict:
        ...
        try:
            ...
            raise ValueError(f"Failed to exchange authorisation code for token: {str(e)}")
    ...
    def get_credentials(self) -> Credentials:
        ...
        try:
            ...
            raise ValueError(f"Failed to load or refresh credentials: {str(e)}")
    ...
    def _save_token(self, token_data: dict):
        try:
            ...
            raise IOError(f"Failed to save token to {self.token_file}: {str(e)}")
